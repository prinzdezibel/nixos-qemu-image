...
This flake allows to cross compile qcow images for QEMU. And of course for the same CPU platform as well. It's basically equivalent to nixos-generators' qow format,
